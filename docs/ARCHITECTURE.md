# Arquitetura — Livro de ofertas P2P via protocolo gossip

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Réplicas eventualmente consistentes com resolução por nonce.
...
|------------|------------------|
| Book | Book em memória |
| Módulo | GossipSub |
| Anti-DDoS | Anti-DDoS rate limit |
| CLI | CLI multi-node |
| Topologia | Topologia mesh documentada |
