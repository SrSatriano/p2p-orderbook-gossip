...
1. Envie descrição detalhada para o mantenedor via GitHub Security Advisories ou contato privado do repositório [p2p-orderbook-gossip](https://github.com/SrSatriano/p2p-orderbook-gossip).
